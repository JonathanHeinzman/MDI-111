...
//  TrailMark
//
//  Created by Jonathan Heinzman on 8/8/26.
//
...
struct RouteMapTestView: View {
    ...
    var body: some View {
        NavigationStack {
            RouteMapView(track: selected.track, showEndpoints: showsEndpoints)
    ...
    private func distanceText(_ track: RouteTrack) -> String {
        Measurement(value: track.distanceMeter, unit: UnitLength.meters)
